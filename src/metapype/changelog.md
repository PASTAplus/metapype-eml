...
## (0.3.0) 2026-03-15
### Changed/Fixed
- Move pixi.dependencies to project.dependencies.

## (0.2.0) 2026-03-13
### Changed/Fixed
- Use ContextVar to achieve task isolation for node store.

## (0.1.4) 2026-01-23
### Changed/Fixed
- Make conditional test for None explicit in `get_text_content()`.

## (0.1.3) 2026-01-21
### Changed/Fixed
- Fix `get_text_content()` when paras or markdown content is None.

## (0.1.2) 2026-01-14
### Changed/Fixed
- Fix `_validate_non_empty_content()` to test for empty or whitespace.
